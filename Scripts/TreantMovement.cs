...
public class TreantMovement : MonoBehaviour
{
    ...
    private void ObtainPosition() {
        ...
        currentNode = myGridManager.GetNodeAtPosition(oneDimensionalCoordinates[Random.Range(0,oneDimensionalCoordinates.Count)],oneDimensionalCoordinates[Random.Range(0,oneDimensionalCoordinates.Count)]);
    ...
    private void Move() {
        ...
        else if(this.transform == tempTargetNode || MissedTempTarget(ref previousDistance) /*tempTargetNode != targetNode*/) {
